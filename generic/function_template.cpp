...
int main()
{
    ...
    std::cout << "Max of " << a << " and " << b << " is: " << my::max<int>(a, b) << std::endl; // 显式调用模板函数，也可以不指定，由编译器推导
    std::cout << "Max of " << x << " and " << y << " is: " << my::max<double>(x, y) << std::endl;
    std::cout << "Max of " << str1 << " and " << str2 << " is: " << my::max<std::string>(str1, str2) << std::endl;
